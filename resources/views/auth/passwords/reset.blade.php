                        ...
                        <div class="login-box">
                            ...
                            <form id="login" method="POST" action="{{ route('password.update') }}">
                             ...
                             <input type="hidden" name="token" value="{{ $token }}">
                                ...
                                <p class="field">
                                    <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $email ?? old('email') }}" placeholder="Enter Your Email" required autofocus>
                                ...
                                <p class="submit">
                                    <button type="submit" name="Reset Password" id="" style="border-radius: 50%;">
