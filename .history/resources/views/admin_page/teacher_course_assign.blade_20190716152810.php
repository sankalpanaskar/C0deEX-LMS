                                ...
                                <div id="collapseOne" class="panel-collapse collapse in">
                                    <div class="box-body">
                                        <a href="javascript:void(0);" class="btn btn-app-teacher">
                                            ...
                                            <div class="btn-group" style="display: block;position: absolute;left: 73px;bottom: 5px;">
                                                <button type="button" class="btn btn-success" data-toggle="tooltip" title="Course Assign"><i class="fa fa-check"></i></button>
                                                <button type="button" class="btn btn-danger" data-toggle="tooltip" title="Hooray!"><i class="fa fa-trash"></i></button>
                                            </div>
                                        </a>
