                                    ...
                                    <div class="box-body">
                                        <a href="javascript:void(0);" class="btn btn-app-teacher">
                                            ...
                                            <div class="btn-group" style="display: block;position: absolute;left: 73px;bottom: 5px;">
                                                <button type="button" class="btn btn-success" data-toggle="tooltip" title="Complete"><i class="fa fa-check"></i></button>
                                                <button type="button" class="btn btn-danger" data-toggle="tooltip" title="Cancel"><i class="fa fa-trash"></i></button>
                                            </div>
                                        </a>
