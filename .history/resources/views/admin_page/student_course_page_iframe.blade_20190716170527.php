            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <iframe src="https://codecombat.com/play" frameborder="0" style="overflow:hidden;overflow-x:hidden;overflow-y:hidden;height:-webkit-fill-available;width:100%;position:absolute;top:0px;left:0px;right:0px;bottom:0px" height="100%" width="100%"></iframe>
                    </div>
                </div>
