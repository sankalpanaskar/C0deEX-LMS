                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-2 col-lg-2 col-sm-4 col-xs-12">
                                                <a class="btn btn-app">
                                                    <i class="fa fa-graduation-cap"></i> Scratch 1
                                                </a>
                                            </div>
                                            <div class="col-md-2 col-lg-2 col-sm-4 col-xs-12">
                                                <a class="btn btn-app">
                                                    <i class="fa fa-graduation-cap"></i> Scratch 2
                                                </a>
                                            </div>
                                            <div class="col-md-2 col-lg-2 col-sm-4 col-xs-12">
                                                <a class="btn btn-app">
                                                    <i class="fa fa-graduation-cap"></i> Scratch 3
                                                </a>
                                            </div>
                                            <div class="col-md-2 col-lg-2 col-sm-4 col-xs-12">
                                                <a class="btn btn-app">
                                                    <i class="fa fa-graduation-cap"></i> Scratch 4
                                                </a>
                                            </div>
                                            <div class="col-md-2 col-lg-2 col-sm-4 col-xs-12">
                                                <a class="btn btn-app">
                                                    <i class="fa fa-graduation-cap"></i> Scratch 5
                                                </a>
                                            </div>
                                            <div class="col-md-2 col-lg-2 col-sm-4 col-xs-12">
                                                <a class="btn btn-app">
                                                    <i class="fa fa-graduation-cap"></i> Scratch 6
                                                </a>
                                            </div>
                                        </div>
                                    </div>
