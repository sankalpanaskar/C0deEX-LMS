                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" multiple="multiple" data-placeholder="Select Qualification"
                                            style="width: 100%;">
            ...
            var u="{{url('/district_fetch')}}/"+$('#state').val();
                ...
                (
                    ...
                    function(res)
                    {
                      ...
                      $('#districts').append($('<option>', {value:'0', text:"Select District"}));
                      res.forEach(function(data){
                                 $('#districts').append($('<option>', {value:data.id, text:data.district_name}));
                              });
            ...
            var u="{{url('/course_fetch')}}/"+$('#course_type').val();
                ...
                (
                    ...
                    function(res)
                    {
                      ...
                      $('#course').append($('<option>', {value:'0', text:"Select Course"}));
                      res.forEach(function(data){
                                 $('#course').append($('<option>', {value:data.id, text:data.course_name}));
                              });
