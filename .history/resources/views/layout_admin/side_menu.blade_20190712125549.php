        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="{{url('/add_student')}}"><i class="fa fa-circle-o"></i> Add Teacher</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i> Teacher List</a></li>
                </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="{{url('/add_course')}}"><i class="fa fa-circle-o"></i> Rank</a></li>
