...
<head>
  ...
  <link rel="shortcut icon" href="{{asset('assets_admin/img/favicon.ico')}}" type="image/x-icon">
  <!-- Bootstrap 3.3.7 -->
...
<body class="hold-transition skin-blue fixed sidebar-mini">
  <div class="overlay" style="position: fixed;width: 100%;height: 100%;z-index: 100000;background: #0000009e;">
    <i class="fa fa-refresh fa-spin" style="position: fixed;left: 50%;top: 50%;color: #fff;font-size: 80px;"></i>
  </div>
<div class="wrapper">
  ...
  <!-- Left side column. contains the logo and sidebar -->
  	@section('side_menu')
    @include('layout_admin.side_menu')
  ...
  <!-- Control Sidebar -->
    @section('right_menu')
    @include('layout_admin.right_menu')
  <!-- /.control-sidebar -->
