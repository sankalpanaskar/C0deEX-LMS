...
class HomeController extends Controller
{
     ...
     public function about_us()
    {
       $states=States::all();
       $coursetype=Course_type::all();
        return view('about_us',compact('states','coursetype'));
    }
    public function animation()
    {
       ...
       $coursetype=Course_type::all();
        ...
        return view('animation',compact('states','coursetype'));
    }
    public function drone_camera()
    {
        $states=States::all();
       $coursetype=Course_type::all();

        return view('drone_camera',compact('states','coursetype'));
    }
    public function web_design()
    {
       ...
       $coursetype=Course_type::all();
        ...
        return view('web_design',compact('states','coursetype'));
    }
    public function video_edit()
    {
       ...
       $coursetype=Course_type::all();
        ...
        return view('video_edit',compact('states','coursetype'));
    }
    public function vfx()
    {
        $states=States::all();
       $coursetype=Course_type::all();
        ...
        return view('vfx',compact('states','coursetype'));
    }
    public function sound_editing()
    {
        $states=States::all();
       $coursetype=Course_type::all();

        return view('sound_editing',compact('states','coursetype'));
    }
    public function photography()
    {
       ...
       $coursetype=Course_type::all();
        ...
        return view('photography',compact('states','coursetype'));
    }
    public function graphics_web_design()
    {
       $states=States::all();
       $coursetype=Course_type::all();
       return view('graphics_web_design',compact('states','coursetype'));
    }
    public function di_color()
    {
       $states=States::all();
       $coursetype=Course_type::all();
       return view('di_color',compact('states','coursetype'));
    }
    public function corporate_event()
    {
       $states=States::all();
       $coursetype=Course_type::all();
       return view('corporate_event',compact('states','coursetype'));
    }
    ...
    public function courses()
    {
       $states=States::all();
       $coursetype=Course_type::all();
        return view('courses',compact('states','coursetype'));
    }
    public function teachers()
    {
       $states=States::all();
       $coursetype=Course_type::all();
        return view('teachers',compact('states','coursetype'));
    }
    public function career()
    {
       $states=States::all();
       $coursetype=Course_type::all();
        return view('career',compact('states','coursetype'));
    }
    public function contact_us()
    {
       $states=States::all();
       $coursetype=Course_type::all();
        return view('contact_us',compact('states','coursetype'));
    }
